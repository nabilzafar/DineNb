...
export default function PromotionSection() {
  ...
  <section className="lg:px-28 md:px-16 px-10 font-poppin my-28">
      ...
      <div className="flex lg:flex-row flex-col items-center justify-center gap-x-4 mt-10">

            <div className="left flex flex-col mx-auto">

                <div className="bg-[#d6d6d8] md:rounded-none rounded-md flex items-center justify-center md:w-[40rem] w-[20rem] md:p-0 px-4 py-5 ">
              <div>
                <h1 className="md:text-4xl text-3xl font-bold">GET UP TO 60%</h1>
                <p>For the summer season</p>
              </div>
              <div className="md:w-72 md:h-48 w-52 h-36">
                <Image src={"/event1.png"} alt="event" width={250} height={250} className="md:mt-0 mt-14" />
              </div>
                </div>
            
              <div className="bg-[#212121] md:rounded-none rounded-md text-white flex flex-col justify-center items-center md:w-[40rem] w-[20rem] mt-4 pb-8">
        ...
        <div className="right flex gap-x-4 md:flex-row flex-col justify-center items-center mx-auto">

            <div className="bg-[#EFE1C7] lg:w-72 md:w-[312px] w-80 lg:mt-0 mt-4">
            ...
            <div className="bg-[#D7D7D9] lg:w-72 md:w-[312px] w-80 lg:mt-0 mt-4">
