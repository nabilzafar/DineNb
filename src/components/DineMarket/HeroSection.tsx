...
export default function HeroSection() {
  return (
    <>
    <section className="lg:px-28 md:px-16 px-10 font-poppin flex items-center space-x-28 mt-10">

        <div className="left">
            <p className="bg-blue-100 w-28 py-2 rounded-md text-center text-[#0000FF] font-bold">Sale 70%</p>
            <h1 className="md:text-6xl text-5xl font-bold mt-10">An Industrial Take <br /> on Streetwear</h1>
            ...
            <div className="flex text-white bg-black w-52 justify-center py-5 gap-x-2 mt-10 
